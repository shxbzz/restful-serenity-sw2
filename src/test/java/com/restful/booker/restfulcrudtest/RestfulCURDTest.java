...
public class RestfulCURDTest  extends TestBase {
    ...
    static String firstname = "Shubh" + TestUtils.getRandomValue();
    static String lastname = "Bum" + TestUtils.getRandomValue();
    static int totalprice = Integer.parseInt(1 + TestUtils.getRandomValue());
    static boolean depositpaid = true;
    static String additionalneeds = "Chocolate";
    ...
    public void test002() {
        ...
        bookingdates.setCheckin("2022-11-30");
        bookingdates.setCheckout("2022-12-21");
